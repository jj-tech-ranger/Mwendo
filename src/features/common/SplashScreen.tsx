    ...
    return (
      <main className="relative h-screen w-screen bg-gradient-to-br from-[#1A5C2E] to-[#0F6E56] flex flex-col justify-between items-center overflow-hidden p-margin-mobile py-xl">
        ...
        <div className="flex flex-col items-center justify-center z-10">
          <img
            src={BRAND_ASSETS.darkLogo}
            alt="Mwendo Salama"
            className="w-48 h-auto object-contain opacity-80 motion-safe:animate-pulse motion-reduce:animate-none"
          />
        </div>
    ...
    return (
      <main className="relative h-screen w-screen bg-gradient-to-br from-[#fcf9f8] to-[#e1f5ee] flex flex-col justify-center items-center overflow-hidden p-margin-mobile">
        ...
        <div className="flex flex-col items-center z-10">
          <img src={BRAND_ASSETS.lightLogo} alt="Mwendo Salama" className="w-48 h-auto object-contain mb-6" />
          <div className="w-64 h-1 overflow-hidden relative mt-2" role="progressbar" aria-label="Loading Mwendo Salama">
  ...
  return (
    <main className="relative h-screen w-screen bg-[#00431b] flex flex-col items-center justify-between overflow-hidden p-margin-mobile py-xl">
      ...
      <div className="flex flex-col items-center z-10 text-center space-y-6">
        <img src={BRAND_ASSETS.darkLogo} alt="Mwendo Salama" className="w-56 h-auto object-contain drop-shadow-2xl" />
      ...
      <div className="w-full flex flex-col items-center pb-8 z-10">
        <div className="relative h-10 w-10" role="status" aria-label="Loading Mwendo Salama">
          <span className="absolute inset-0 rounded-full border-2 border-sage-light/20 motion-safe:animate-pulse motion-reduce:animate-none" />
          <span className="absolute inset-2 rounded-full border-2 border-sage-light/60 border-t-transparent motion-safe:animate-spin motion-reduce:animate-none" />
          <span className="absolute inset-[13px] rounded-full bg-sage-light motion-safe:animate-pulse motion-reduce:animate-none" />
        </div>
