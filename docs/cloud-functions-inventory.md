...
| `generateTripSummary` | `risk/generateTripSummary.ts` | Callable | App Check, Gemini AI / rule engine fallback, trip violation synthesis; covered by tests in `generate-trip-summary.test.ts` |
